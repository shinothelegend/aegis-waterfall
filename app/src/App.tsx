...
export default function App() {
  ...
  const {
    ...
    fetchData,
    fetchBadges,
  } = useCheckpointData(attestationAddress);
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-3">
            <input 
              ...
              className="bg-[#050505] border border-white/10 rounded px-3 py-1 text-[11px] font-mono text-cyan-400 focus:outline-none focus:border-cyan-400"
            />
            <input 
              type="text" 
              ...
              className="bg-[#050505] border border-white/10 rounded px-3 py-1 text-[11px] font-mono text-purple-400 focus:outline-none focus:border-purple-400"
            />
            <button 
              onClick={() => saveSettings(treasuryAddress, attestationAddress)}
              className="bg-cyan-500 text-black hover:brightness-110 font-bold px-4 py-1 rounded transition text-[11px]"
            >
              Update Config
            </button>
          </div>
